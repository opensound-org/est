...
Latest version: [v0.8.1](https://github.com/opensound-org/est/releases/tag/v0.8.1)
...
![MSRV (version)](https://img.shields.io/crates/msrv/est/0.8.1?label=v0.8.1-msrv)
[![dependency status (version)](https://deps.rs/crate/est/0.8.1/status.svg?subject=v0.8.1-deps)](https://deps.rs/crate/est/0.8.1)
...
[![Static Badge](https://img.shields.io/badge/build_with-Rust_1.86.0-dca282)](https://blog.rust-lang.org/2024/11/28/Rust-1.86.0.html)
